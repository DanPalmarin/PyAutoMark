...
class Ui_Window2(object):
    def setupUi(self, Window2):
        ...
        self.win2label1.setGeometry(QtCore.QRect(120, 10, 101, 31))
        self.win2label1.setObjectName("win2label1")
        self.win2label2 = QtWidgets.QLabel(Window2)
        self.win2label2.setGeometry(QtCore.QRect(120, 50, 101, 31))
    ...
    def retranslateUi(self, Window2):
        ...
        self.win2label1.setText(_translate("Window2", "Path to file"))
        self.win2label2.setText(_translate("Window2", "Path to folder"))
